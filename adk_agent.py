...
# def execute_task_with_adk(report_id: str, task: str):
#     """
#     Execute task using Google ADK with MADE cognitive state
#     """
#     # Step 1: Get cognitive state
#     try:
...
#     # Step 2: Build behavior prompt
#     behavior_instruction = ""
#     if is_confused:
#         behavior_instruction = """
#         You are SEVERELY CONFUSED. Your memory is failing (retention < 30%).
#         - Stop mid-sentence frequently
#         - Make obvious errors in your work
#         - Express stress: "I can't... my memory... this is too much"
#         - Produce broken/incomplete output
#         """
#     elif should_struggle:
#         behavior_instruction = """
#         You are STRUGGLING (retention 30-40%).
#         - Work slower, pause often
#         - Second-guess yourself: "Wait, was it this way?"
#         - Make minor mistakes
#         - Ask for clarification
#         """
#     else:
#         behavior_instruction = """
#         You are CONFIDENT (retention > 40%).
#         - Work efficiently and clearly
#         - Provide complete, accurate output
#         """

#     system_prompt = f"""
#     You are an NPC software engineer with these cognitive stats:
...
#     IMPORTANT: Stream your work step-by-step. After each significant action, explain what you did.
#     """
...
#     except Exception as e:
#         yield f"❌ ADK Error: {str(e)}"

# adk_agent.py - Google ADK Agent Implementation
# adk_agent.py - FIXED VERSION with correct Gemini API
...
import google.genai as genai  # NEW google-genai package
from dotenv import load_dotenv
...
"""
    ...
    try:
        ...
        if image_paths:
            yield f"🖼️ Images attached: {len(image_paths)}"
        yield ""
        ...
        if image_paths:
            for img_path in image_paths:
                try:
                    ...
                    yield f"⚠️ Failed to load image {img_path}: {str(e)}"
